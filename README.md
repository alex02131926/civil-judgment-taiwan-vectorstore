...
> **Scope**: This skill is exclusively designed for Taiwan civil judgments sourced from the Judicial Yuan's FJUD/FINT systems via the `judicialyuan-search` skill. It is not intended for criminal, administrative, or non-Taiwan judgments.
