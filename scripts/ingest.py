...
def split_sections(plain_text: str) -> Dict[str, str]:
    ...
    This is intentionally conservative; v1 focuses on clean chunk retrieval.
    """
    ...
    for i, ln in enumerate(lines):
        # exact heading match only (reduces false positives)
...
def main() -> int:
    ...
    for input_path in input_files:
        ...
        doc_payload: Dict[str, Any] = {
            ...
            "parser_version": "v3.5-sentence-boundary",
            "level": "doc",
        }
